  ...
  return (
    <main className="min-h-screen bg-transparent relative flex flex-col">
      ...
      <section className="flex-1 py-32 relative overflow-hidden flex items-center justify-center">
        ...
        <div className="max-w-4xl mx-auto px-4 w-full relative z-10 bg-white/40 backdrop-blur-3xl rounded-[3rem] shadow-[0_30px_80px_rgba(0,0,0,0.1)] border border-white/60 overflow-hidden p-10 lg:p-16 flex flex-col items-center text-center">
          ...
          >
            ...
            <div className="flex flex-col items-center justify-center">
              <div className="w-56 h-56 bg-white/50 backdrop-blur-sm border-2 border-dashed border-gray-300 rounded-[2rem] flex flex-col items-center justify-center mb-6 shadow-sm group hover:border-[#05D0D0] hover:shadow-xl transition-all duration-500 relative overflow-hidden cursor-pointer hover:-translate-y-1">
                 <div className="absolute top-4 left-4 w-6 h-6 border-t-4 border-l-4 border-gray-300 group-hover:border-[#05D0D0] transition-colors rounded-tl-xl"></div>
                 <div className="absolute top-4 right-4 w-6 h-6 border-t-4 border-r-4 border-gray-300 group-hover:border-[#05D0D0] transition-colors rounded-tr-xl"></div>
                 <div className="absolute bottom-4 left-4 w-6 h-6 border-b-4 border-l-4 border-gray-300 group-hover:border-[#05D0D0] transition-colors rounded-bl-xl"></div>
                 <div className="absolute bottom-4 right-4 w-6 h-6 border-b-4 border-r-4 border-gray-300 group-hover:border-[#05D0D0] transition-colors rounded-br-xl"></div>
